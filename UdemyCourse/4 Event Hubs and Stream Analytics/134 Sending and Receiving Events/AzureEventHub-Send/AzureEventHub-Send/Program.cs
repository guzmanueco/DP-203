...
namespace AzureEventHub_Send
{
    class Program
    {
        private static string connection_string = "Endpoint=sb://guzman-azure-event-hub.servicebus.windows.net/;SharedAccessKeyName=Send;SharedAccessKey=TQD30Xv2rLWtNoy8MsaCo4DgBDRSXCDQwNOR3WrrDfQ=;EntityPath=guzmanhub";
